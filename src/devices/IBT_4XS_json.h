...
const char* _IBT_4XS_json = "{\"brand\":\"Inkbird\",\"model\":\"iBBQ\",\"model_id\":\"IBT-4X(S/C)\",\"cidc\":false,\"condition\":[\"name\",\"index\",0,\"iBBQ\",\"&\",\"manufacturerdata\",\"=\",36,\"index\",0,\"00000000\"],\"properties\":{\"tempc\":{\"condition\":[\"manufacturerdata\",22,\"!\",\"ff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",20,4,true,false],\"post_proc\":[\"/\",10]},\"state\":{\"decoder\":[\"bit_static_value\",\"manufacturerdata\",22,2,\"on\",\"off\"]},\"tempc2\":{\"condition\":[\"manufacturerdata\",26,\"!\",\"ff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",24,4,true,false],\"post_proc\":[\"/\",10]},\"state2\":{\"decoder\":[\"bit_static_value\",\"manufacturerdata\",26,2,\"on\",\"off\"]},\"tempc3\":{\"condition\":[\"manufacturerdata\",30,\"!\",\"ff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",28,4,true,false],\"post_proc\":[\"/\",10]},\"state3\":{\"decoder\":[\"bit_static_value\",\"manufacturerdata\",30,2,\"on\",\"off\"]},\"tempc4\":{\"condition\":[\"manufacturerdata\",34,\"!\",\"ff\"],\"decoder\":[\"value_from_hex_data\",\"manufacturerdata\",32,4,true,false],\"post_proc\":[\"/\",10]},\"state4\":{\"decoder\":[\"bit_static_value\",\"manufacturerdata\",34,2,\"on\",\"off\"]}}}";
/*R""""(
{
   "brand":"Inkbird",
   "model":"iBBQ",
...
const char* _IBT_4XS_json_props = "{\"properties\":{\"tempc\":{\"unit\":\"°C\",\"name\":\"temperature\"},\"state\":{\"unit\":\"string\",\"name\":\"state\"},\"tempc2\":{\"unit\":\"°C\",\"name\":\"temperature\"},\"state2\":{\"unit\":\"string\",\"name\":\"state\"},\"tempc3\":{\"unit\":\"°C\",\"name\":\"temperature\"},\"state3\":{\"unit\":\"string\",\"name\":\"state\"},\"tempc4\":{\"unit\":\"°C\",\"name\":\"temperature\"},\"state4\":{\"unit\":\"string\",\"name\":\"state\"}}}";
/*R""""(
{
   "properties":{
      "tempc":{
